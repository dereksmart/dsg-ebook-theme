( function ( wp ) {
	...
	function pageOptions( pages ) {
		var options = [
			{
				label: __( 'Select a source page', 'dsg-ereader' ),
				value: '',
			},
		];
	...
	function ProjectsControls( props ) {
		...
		return el(
			...
			el(
				PanelBody,
				{
					title: __( 'Temporary source', 'dsg-ereader' ),
					initialOpen: true,
				},
				el( SelectControl, {
					label: __( 'Projects page', 'dsg-ereader' ),
					help: __( 'This is a bridge until projects move into a dsg_project content type.', 'dsg-ereader' ),
			...
			el(
				...
				el( TextControl, {
					...
					placeholder: __( 'Chapter Two', 'dsg-ereader' ),
				...
				el( TextControl, {
					...
					help: __( 'Leave blank to use the source page title.', 'dsg-ereader' ),
			...
			el(
				...
				el( ToggleControl, {
					label: __( 'Show page intro', 'dsg-ereader' ),
	...
	function Edit( props ) {
		var blockProps = useBlockProps( {
			className: 'dsg-projects-chapter-editor-preview',
		} );

		return el(
			'div',
			blockProps,
			el( ProjectsControls, props ),
			el( ServerSideRender, {
				block: 'dsg/projects-chapter',
				attributes: props.attributes,
			} )
		);
	}

	registerBlockType( 'dsg/projects-chapter', {
		title: __( 'Projects Chapter', 'dsg-ereader' ),
		description: __( 'Render the temporary Projects page bridge as an ereader works chapter.', 'dsg-ereader' ),
		category: 'theme',
		icon: 'portfolio',
		attributes: {
			slug: {
